function namegenSciFiPlace(count) {
  ...
  return ret;
};//To get capitilized string from name, run: name = String(name); name = name.charAt(0).toUpperCase() + name.slice(1);
function namegenAlphaNumID(length, chars) {
    var mask = '';
    ...
    return result;
};//Expects an input like: namegenAlphaNumID(64, '#A!');
